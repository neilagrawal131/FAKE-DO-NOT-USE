...
export async function quote(symbol) {
  ...
  return {
    ...
    description: `${c.name} is a simulated ${c.sector} company used for offline demos of the Paper Trader platform. Prices shown here are generated by a seeded random walk and do not represent real market data. Set DATA_SOURCE=yahoo (the default) to trade against live NYSE/NASDAQ prices.`,
